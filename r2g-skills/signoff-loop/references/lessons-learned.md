...
- Upstream ORFS doesn't ship a nangate45 LVS rule; the skill now bundles one at `r2g-skills/signoff-loop/assets/platforms/nangate45/lvs/FreePDK45.lylvs`. Install with `tools/install_nangate45_lvs.sh`.
...
canonical installer is `r2g-skills/install.sh`). Resumable multi-design campaigns now run
