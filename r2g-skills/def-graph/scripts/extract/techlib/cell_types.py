...
nangate45 previously used the curated ``NANGATE45_CELL_TYPE_MAPPING`` below — retired
...
The dict is kept ONLY as an import-compat shim; nothing resolves through it, and any
nangate45 dataset built against it must be regenerated. See failure-patterns.md
("Dataset-Extraction Silent-Value Defects" #12).
