...
-- Knowledge authority is a separate, append-only decision ledger.  It is
-- additive to the frozen v4 schema: content/status/evidence rows remain the
-- source of truth and this table only records a replayable authority view.
