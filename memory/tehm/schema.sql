...
-- =====================================================================
-- Intervention-grounded Mechanism Knowledge (P3 additive shadow tables)
-- =====================================================================
-- Knowledge claims are immutable interpretations of causal evidence.  Their
-- lifecycle is kept separate from canonical evidence and never introduces a
