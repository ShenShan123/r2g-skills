...
from .receipts import (
    ...
    AssetValidationReceipt, CapabilityGapReceipt,
)
...
from .synthesis import (
    AssetProposal, bind_rtl_asset_to_project, build_rtl_asset_proposal,
...
__all__ = [
    ...
    "CapabilityGapReceipt", "detect_capability_gap", "detect_capability_gaps",
