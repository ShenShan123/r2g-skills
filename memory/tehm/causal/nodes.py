...
def persist_node(conn: sqlite3.Connection, node: CausalNode,
    ...
    """Insert a node idempotently; this never touches canonical tables."""
    conn.execute(
        """INSERT OR IGNORE INTO tehm_causal_nodes
        ...
        node.to_row(created_at=created_at))
    return node.causal_node_id
