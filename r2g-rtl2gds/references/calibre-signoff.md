...
```bash
R2G_CALIBRE_SMOKE=1 bash r2g-rtl2gds/scripts/flow/run_calibre_drc.sh <project-dir> asap7
```
...
```bash
bash r2g-rtl2gds/scripts/flow/run_calibre_drc.sh <project-dir> asap7
